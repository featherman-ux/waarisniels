...
// .wrangler/tmp/bundle-C0NmKi/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/pages-f6i7lY/functionsWorker-0.6038707084022752.mjs
...
var onRequestOptions = /* @__PURE__ */ __name2(async () => new Response(null, { headers: cors }), "onRequestOptions");
...
var onRequestPost2 = /* @__PURE__ */ __name2(async ({ request, env }) => {
  ...
  const cleanMsg = message.trim().slice(0, 1e3);
  ...
  if (already) return bad("Even rustig aan \u{1F609}", 429);
  await env.bibbibib.put(ipKey, "1", { expirationTtl: 30 });
  const key = `comments:${slug}`;
  const now = (/* @__PURE__ */ new Date()).toISOString();
  const list = JSON.parse(await env.bibbibib.get(key) || "[]");
  const item = {
...
// .wrangler/tmp/bundle-C0NmKi/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-C0NmKi/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.6038707084022752.js.map
